 ...
 * Time: 10:22
 */
namespace Magenest\GiftCard\Model\Entity\Attribute\Source\Price;

class Scheme extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
     * Option values
     */
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            $this->_options = [
                ...
                ['label' => __('Selected'), 'value' => self::VALUE_SELECTED],
                ['label' => __('Range'), 'value' => self::VALUE_RANGE],
            ];
        }
    ...
    {
        switch ($value) {
            case self::VALUE_FIXED:
                return 'Fixed';
            case self::VALUE_SELECTED:
                return 'Selected';
            case self::VALUE_RANGE:
                return 'Range';
        }
